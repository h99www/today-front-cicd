...
export function registChallengeReportAccept(acceptInfo) {
  ...
  const REGIST_ACCEPT_URL = 'http://43.200.141.242:8888/reports/accept';
...
export function checkReportExamineAlreadyAcceptedAPI(reportNo) {
  ...
  const CHECK_CHELLENGE_REPORT_ACCEPTED_URL = 'http://43.200.141.242:8888/reports/acceptedcheck';
