...
export function getRankingsAPI() {
  ...
  const GET_RANKINGS_URL = 'http://43.200.141.242:8888/challenges/rankings';
...
export function getMainLayoutChallengeListAPI(categoryNo) {
  ...
  const GET_CHALLENGE_LIST_BY_CATEGORY_URL = 'http://43.200.141.242:8888/challenges/category/' + categoryNo;
