...
export function callReportRefuseAPI(refuseInfo) {
  ...
  const REFUSE_REPORT_URL = 'http://43.200.141.242:8888/reports/refuse';
...
export function callPostChallengeReportATI(registInfo) {
  const REGIST_REPORT_URL = 'http://43.200.141.242:8888/reports';
...
export function checkChallengeReportAPI(checkInfo) {
  ...
  const CHECK_CHALLENGE_REPORT_URL = 'http://43.200.141.242:8888/reports/challengecheck';
...
export function getchallengeReportsAPI(pageInfo) {
  const GET_CHALLENGE_REPORT_URL = 'http://43.200.141.242:8888/reports';
...
export function getReportAPI(reportNo) {
  const GET_REPORT_URL = 'http://43.200.141.242:8888/reports/' + reportNo;
