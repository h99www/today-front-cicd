...
export function getAlarmsAPI(findInfo) {
  ...
  const GET_ALARMS_URL = 'http://43.200.141.242:8888/alarms';
...
export async function putAlarmCheckYNAPI(alarmNo) {
  const PUT_ALARM_STATE_URL = 'http://43.200.141.242:8888/alarms/check';
...
export function getAlarmExistAPI(memberNo) {
  ...
  const GET_ALARM_EXIST_URL = 'http://43.200.141.242:8888/alarms/check';
