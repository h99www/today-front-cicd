...
export async function loginAPI(id, password) {
  ...
  return await axios.post('http://43.200.141.242:8888/members/login', data)
...
export function logoutAPI(data) {
  ...
  return axios.get('http://43.200.141.242:8888/logout', {params: {token: data}})
}
...
export function signUpDB(id, password, nickname) {
  ...
  axios.post("http://43.200.141.242:8888/members", data)
  .then((res) => {
...
export function checkEmail(email) {
  ...
  return async function getDuplicateResult(dispatch, getState) {
    ...
    axios.get("http://43.200.141.242:8888/members/idcheck", {params: {email: email}})
    .then((res) => {
    console.log(res);
...
export function sendEmailAPI(email) {
  ...
  return async function checkAuthNumber(dispatch, getState) {
    ...
    axios.get("http://43.200.141.242:8888/members/email", {params: {email: email}})
    .then((res) => {
      console.log(res);
...
export function resetPwdAPI(email) {
  ...
  return async function resetPwdEmail(dispatch, getState) {
    ...
    axios.post('http://43.200.141.242:8888/members/reset-pwd', data)
    .then((result) => {
...
export function findId(id) {
  ...
  return async function checkId(dispatch, getState) {
    axios.get('http://43.200.141.242:8888/members/idcheck', {params: {email: id}})
    .then((res) => {
...
export function confirmPwdAPI(memberNo, pwd) {
  ...
  return new Promise((resolve, reject) => {
    axios.post('http://43.200.141.242:8888/members/pwd', data)
    .then((res) => {
      resolve(res.data);
    })
...
export function changePwdAPI(memberNo, pwd) {
  ...
  return new Promise((resolve, reject) => {
    axios.put('http://43.200.141.242:8888/members/pwd', data)
    .then((res) => {
      resolve(res.data);
    })
  })
