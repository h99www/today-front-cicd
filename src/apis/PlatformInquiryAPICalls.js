...
export function callPostInquiryAPI(registInfo) {
    let REGIST_INQUIRY_URL = 'http://43.200.141.242:8888/inquiries';
...
export function callGetInquiriesAPI({memberNo, pageInfo}) {
  ...
  let GET_INQUIRIES_API_URL = 'http://43.200.141.242:8888/inquiries';
...
export function callGetInquiryAPI(inquiryNo) {
  ...
  let GET_INQUIRY_API_URL = `http://43.200.141.242:8888/inquiries/${inquiryNo}`;
...
export function callAdminGetInquiriesAPI(pageInfo) {
  ...
  let GET_INQUIRIES_API_URL = 'http://43.200.141.242:8888/inquiries/all';
  return async function getInquiries(dispatch, getState) {
...
export function callPutReplyAPI(reply) {
  let PUT_REPLY_API_URL = 'http://43.200.141.242:8888/inquiries/reply';
...
export function callPostReplyAPI(inquiryInfo) {
  ...
  let POST_REPLY_API_URL = 'http://43.200.141.242:8888/inquiries/reply';
