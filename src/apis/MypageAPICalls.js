...
export function mypageInfoAPI(memberNo) {
  ...
  return new Promise(async (resolve, reject) => {
    ...
    await axios.get('http://43.200.141.242:8888/members', {params: {memberNo: memberNo}})
    .then((res) => {
...
export function mypageChallenges(memberNo) {
  return new Promise(async (resolve, reject) => {
    ...
    await axios.get('http://43.200.141.242:8888/members/challenges', {params: {memberNo: memberNo}})
    .then((res) => {
      console.log('API')
      resolve(res);
    })
