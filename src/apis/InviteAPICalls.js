...
export function checkUserEmailAPI(email) {
  ...
  const GET_USER_EMAIL_URL = 'http://43.200.141.242:8888/members/checkEmail';
...
export async function postInviteAPI(inviteInfo) {
  ...
  const POST_INVITE_URL = 'http://43.200.141.242:8888/invites';
...
export function getInvitesAPI(findInfo) {
  ...
  const GET_INVITES_URL = 'http://43.200.141.242:8888/invites';
...
export function deleteInviteAPI(inviteNo) {
  ...
  const DELETE_INVITE_URL = 'http://43.200.141.242:8888/invites';
