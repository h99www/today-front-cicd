...
export function callGetChallengeInfoAPI(challengeNo) {
    ...
    let FIND_CHALLENGE_INFO_URL = 'http://43.200.141.242:8888/challenges/' + challengeNo;
...
export function checkChallengeAuthByMemberNoAPI(authInfo) {
    ...
    let CHECK_AUTH_URL = 'http://43.200.141.242:8888/challenges/checkAuth';
...
export function getChallengeList(pageInfo) {
    const GET_CHALLENGE_LIST_URL = 'http://43.200.141.242:8888/challenges';
...
export function registChallengeAPI(registInfo) {
    const POST_CHALLENGE_URL = 'http://43.200.141.242:8888/challenges';
...
export async function registChallengeImagesAPI({inputFile}) {
    ...
    const POST_CHALLENGE_IMAGE_URL = 'http://43.200.141.242:8888/challenges/upload';
...
export async function participatingChallengeAPI(memberNo, challengeNo) {
    ...
    return new Promise(async(resolve, reject) => {
        ...
        const url = 'http://43.200.141.242:8888/challenges/' + challengeNo ;
...
export async function removeChallengeAPI(challengeNo) {
    const DELETE_CHALLENGE_URL = 'http://43.200.141.242:8888/challenges';
...
export async function modifyChallengeAPI(modifyInfo) {
    const MODIFY_CHALLENGE_URL = 'http://43.200.141.242:8888/challenges';
...
export async function secessionChallengeAPI(secessionInfo) {
    const CHALLENGE_SECESSION_URL = 'http://43.200.141.242:8888/challenges/secession';
...
export async function registChallengeInquiryAPI(title, content, memberNo, challengeNo) {
    ...
    const CHALLENGE_INQUIRY_REGIST_URL = 'http://43.200.141.242:8888/challenges/'+ challengeNo + '/inquiries';
...
export async function findChallengeInquiryListAPI(challengeNo) {
    ...
    const CHALLENGE_LIST_URL = 'http://43.200.141.242:8888/challenges/' + challengeNo + '/inquiries';
...
export async function modifyChallengeInquiryAPI(title, content, challengeNo, inquiryNo) {
    ...
    const CHALLENGE_INQUIRY_MODIFY_URL = 'http://43.200.141.242:8888/challenges/' + challengeNo + '/inquiries/' + inquiryNo;
...
export async function removeInquiryAPI(challengeNo, inquiryNo) {
    const CHALLENGE_INQUIRY_DELETE_URL = 'http://43.200.141.242:8888/challenges/' + challengeNo + '/inquiries/' + inquiryNo;
    return new Promise((resolve, reject) => {
