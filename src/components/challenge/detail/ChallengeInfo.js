            ...
            <div className={ ChallengeInfoCSS.infoContent }>
                ...
                <div className={ ChallengeInfoCSS.infoImgArea }>
                    ...
                    {   attachmentInfo[2] && attachmentInfo[2].hasOwnProperty('savedPath')
                        ?<img src={ 'http://43.200.141.242:8888' + attachmentInfo[2].savedPath + '/'+ attachmentInfo[2].savedName + '.png' } className={ ChallengeInfoCSS.infoExample }/>
                        :null
                    }
                    <span className={ ChallengeInfoCSS.infoSubImgTitle }>나쁜 인증샷 예시</span>
                    {   attachmentInfo[3] && attachmentInfo[3].hasOwnProperty('savedPath')
                        ?<img src={ 'http://43.200.141.242:8888' + attachmentInfo[3].savedPath + '/'+ attachmentInfo[3].savedName + '.png' } className={ ChallengeInfoCSS.infoExample }/>
                        :null
                    }
                </div>
            </div>
